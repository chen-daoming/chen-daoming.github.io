...
![航模接收机实物](/images/航模接收机/01-receiver-protocols.svg)
...
![PWM 波形示意图：周期约 2ms 的方波，高电平宽度即信号量](/images/航模接收机/02-pwm-waveform.svg)
...
![PPM 帧波形与解码：一帧内 t1~t6 为 6 个通道脉宽，尾部 Synchro Blank Time 为同步空白](/images/航模接收机/03-ppm-frame.svg)
...
![SBUS 硬件取反电路：RC_SBUS 经 1K 接三极管基极，集电极 10K 上拉 VCC3V3 后输出 RXD](/images/航模接收机/04-sbus-inverter.svg)
...
![Saleae Logic 抓取的 PPM 输出波形](/images/航模接收机/05-ppm-logic-analyzer.svg)
